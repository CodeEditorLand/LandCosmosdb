...
> {
	...
	public visitCommands(
		ctx: mongoParser.CommandsContext
	): Promise<CompletionItem[]> {
	...
	public visitCommand(
		ctx: mongoParser.CommandContext
	): Promise<CompletionItem[]> {
		if (ctx.childCount === 0) {
			return this.thenable(
				this.createDbKeywordCompletion(this.createRange(ctx))
	...
	public visitArgument(
		ctx: mongoParser.ArgumentContext
	): Promise<CompletionItem[]> {
		return ctx.parent!.accept(this);
	}

	public visitObjectLiteral(
	...
	public visitElementList(
		ctx: mongoParser.ElementListContext
	): Promise<CompletionItem[]> {
		return ctx.parent!.accept(this);
	}

	public visitPropertyNameAndValueList(
		ctx: mongoParser.PropertyNameAndValueListContext
	): Promise<CompletionItem[]> {
		return ctx.parent!.accept(this);
	}

	public visitPropertyAssignment(
	...
	public visitLiteral(
		ctx: mongoParser.LiteralContext
	): Promise<CompletionItem[]> {
		return ctx.parent!.accept(this);
	}
