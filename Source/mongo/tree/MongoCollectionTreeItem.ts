	...
	implements IEditableTreeItem
{
	...
	public async writeFileContent(
		...
		const result: BulkWriteOpResultObject =
	...
	public async createChildImpl(
		...
		const result: InsertOneWriteOpResult<MongoDocument> =
	...
	private async insertOne(document: Object, options?: any): Promise<string> {
		...
		const insertOneResult: InsertOneWriteOpResult<MongoDocument> =
			await this.collection.insertOne(document, {
				w: options && options.writeConcern,
			});
	...
	private async insertMany(documents: any[], options?: any): Promise<string> {
		...
		// eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
		const insertManyResult: InsertWriteOpResult<MongoDocument> =
