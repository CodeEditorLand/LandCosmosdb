...
export type PostgresAbstractServer = (
	| SingleModels.Server
...
export type PostgresAbstractDatabase =
...
export type AbstractNameAvailability =
	| SingleModels.NameAvailability
	| FlexibleModels.NameAvailability;

export type AbstractFirewallRule =
	| SingleModels.FirewallRule
	| FlexibleModels.FirewallRule;
