...
const alternativeGraphVisualizationToolsDocLink =
	"https://aka.ms/cosmosdb-graph-alternative-tools";
...
export class GraphTreeItem extends AzExtTreeItem {
	...
	constructor(
		parent: GraphCollectionTreeItem,
	...
	public async showExplorer(_context: IActionContext): Promise<void> {
		const message: string = localize(
			"mustInstallGraph",
			"Cosmos DB Graph extension has been retired.",
		);
