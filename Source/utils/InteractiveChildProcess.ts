...
export class InteractiveChildProcess {
	...
	public static async create(
		options: IInteractiveChildProcessOptions,
	): Promise<InteractiveChildProcess> {
	...
	private writeLineToOutputChannel(
		text: string,
	...
	private filterText(text: string): string {
		if (this._options.outputFilterSearch) {
			return text.replace(
				this._options.outputFilterSearch,
				this._options.outputFilterReplace || "",
			);
		}
