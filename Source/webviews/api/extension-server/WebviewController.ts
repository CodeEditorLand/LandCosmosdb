...
} from "../webview-client/vscodeLink";
...
export class WebviewController<
	Configuration,
> extends WebviewBaseController<Configuration> {
						...
						default:
							try {
								...
								if (typeof procedure !== "function") {
									throw new Error(
										`Procedure not found: ${message.op.path}`,
									);
								}
	...
	public postNotification(notification: string, parameters: unknown) {
		const message: VsCodeLinkNotification = {
